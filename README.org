...
1. 定义一个用户接口变量
   ...
   (defcustom eltips-name "eltips-name"
     "The name of elptips.")
   #+END_SRC
   ...
   #+BEGIN_SRC emacs-lisp
   (defvar eltips-name "eltips-name"
     "The name of elptips.")
   #+END_SRC
2. 定义一个只读全局变量
   #+BEGIN_SRC emacs-lisp
   (defconst eltips-name "eltips-name"
     "Eltips's name")
   #+END_SRC
